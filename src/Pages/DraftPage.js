...
const DraftPage = () => {
  ...
  function sub() {
    const id = "03b7a95b-3a99-41c5-8355-dbe40acfa051";
    const subscription = DataStore.observe(Draft, id).subscribe((msg) => {
      console.log(msg);
    });
  }
  ...
  return (
    <div className="draft-page">
      <header className="draft-header">
        ...
        <div className="draft-clock" id={timeLeft < 15 ? "time-alert" : ""}>
      ...
      >
        <div className="resizeable-handle" onMouseDown={handleMouseDown}></div>
