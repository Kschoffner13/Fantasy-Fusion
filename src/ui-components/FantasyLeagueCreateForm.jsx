...
export default function FantasyLeagueCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setDraftDate(initialValues.DraftDate);
    setTradeDeadline(initialValues.TradeDeadline);
    setPlayoffStartDate(initialValues.PlayoffStartDate);
    setPlayoffTeams(initialValues.PlayoffTeams);
    setPlayoffMatchupLength(initialValues.PlayoffMatchupLength);
    setWeeklyPickups(initialValues.WeeklyPickups);
    setVetoVoteEnabled(initialValues.VetoVoteEnabled);
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "FantasyLeagueCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
